...
type
  ...
  ModelClass=class
    ...
    function GetLightOMEGA(x:VecRecord):real;virtual;abstract;
  ...
  SphereClass=class(ModelClass)
    ...
    function GetLightOMEGA(x:VecRecord):real;override;
...
function SphereClass.GetLightOMEGA(x:VecRecord):real;
var
  tr:real;
begin
